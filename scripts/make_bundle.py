...
def main():
    ...
    write_json(session/'reports'/'bundle_export_report.json', {'schema':'arc.streammemory.bundle_export_report.v1','created_at':utc_now(),'bundle':str(out),'sha256':sha256_file(out)})
    print(out)
